...
public class EntityTrackerClientPacket {
    public final CompoundTag tag;
    public final String dimension;

    public EntityTrackerClientPacket(FriendlyByteBuf buffer) {
    ...
    public static EntityTrackerClientPacket of(List<EntityPosition> types, String dimension) {
        ...
        return new EntityTrackerClientPacket(tag, dimension);
    }
